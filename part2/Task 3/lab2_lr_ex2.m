...
h=plot_data_function(training_input,training_output);%% draw a classification line to classify 1 and 0 for training dataset
...
plot_data_function(test_input,test_output);%% draw a classification line to classify 1 and 0 for testing dataset
